...
This compatibility command keeps `/oh-my-qoder:visual-verdict` available without loading the full `visual-verdict` skill description in every Qoder session.
