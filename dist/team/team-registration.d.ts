 ...
 */
export declare function registerMcpWorker(teamName: string, workerName: string, provider: 'codex' | 'gemini' | 'qoder', model: string, tmuxTarget: string, cwd: string, workingDirectory: string): void;
/**
