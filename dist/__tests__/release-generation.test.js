...
describe('release generation', () => {
    ...
    it('keeps non-conventional PRs in other changes and renders exact PR counts', () => {
        const pullRequests = [
            ...
            { number: '2144', title: 'fix: preserve existing global AGENTS.md during setup', author: 'Yeachan-Heo', headRefName: 'issue-2143-safe-setup-config' },
    ...
    it('assembles a single custom release body with compare link and contributors', () => {
        const body = generateReleaseBody('4.10.2', '# oh-my-qoder v4.10.2: Bug Fixes', ['blue-int', 'DdangJin', 'Yeachan-Heo'], 'v4.10.1');
        expect(body).toContain('npm install -g oh-my-qoder@4.10.2');
