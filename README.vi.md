...
**Điều phối đa tác tử cho Qoder. Không cần thời gian làm quen.**

*Đừng học Qoder. Cứ dùng OMC.*

[Bắt đầu nhanh](#bắt-đầu-nhanh) • [Tài liệu](https://yeachan-heo.github.io/oh-my-qoder-website) • [Tham chiếu CLI](https://yeachan-heo.github.io/oh-my-qoder-website/docs/#cli-reference) • [Quy trình](https://yeachan-heo.github.io/oh-my-qoder-website/docs/#workflows) • [Hướng dẫn di chuyển](docs/MIGRATION.md) • [Discord](https://discord.gg/sj4exxQ9v)
...
Nếu bạn chạy OMC qua `omc --plugin-dir <path>` hoặc `qodercli --plugin-dir <path>`, hãy thêm `--plugin-dir-mode` vào `omc setup` (hoặc xuất `OMC_PLUGIN_ROOT` trước) để tránh trùng lặp các kỹ năng/tác nhân mà plugin đã cung cấp trong thời gian chạy. Để xem ma trận quyết định đầy đủ và tất cả các cờ có sẵn, hãy xem [phần Plugin directory flags trong REFERENCE.md](./docs/REFERENCE.md#plugin-directory-flags).
...
Bật Qoder native teams trong `~/.qoder/settings.json`:
...
| `/omc-teams N:qoder` | N pane Qoder CLI | Tác vụ chung qua Qoder CLI trong tmux |
...
> **Lưu ý: Tên package** — Dự án được xây dựng thương hiệu là **oh-my-qoder** (repo, plugin, commands), nhưng package npm được phát hành dưới tên [`oh-my-qoder`](https://www.npmjs.com/package/oh-my-qoder). Nếu bạn cài công cụ CLI qua npm/bun, hãy dùng `npm install -g oh-my-qoder`.
...
Nhiều chiến lược cho nhiều tình huống — từ điều phối dựa trên Team đến refactor tiết kiệm token. [Tìm hiểu thêm →](https://yeachan-heo.github.io/oh-my-qoder-website/docs/#execution-modes)
...
Tự động khôi phục phiên Qoder khi rate limit được reset.
...
Chuyển tiếp các sự kiện phiên Qoder đến gateway [OpenClaw](https://openclaw.ai/) để kích hoạt phản hồi tự động và quy trình làm việc thông qua tác nhân OpenClaw của bạn.
...
**Thiết lập thủ công:** tạo `~/.qoder/omc_config.openclaw.json`:
...
- **[Tham chiếu CLI](https://yeachan-heo.github.io/oh-my-qoder-website/docs/#cli-reference)** - Tất cả lệnh, cờ và công cụ `omc`
- **[Hướng dẫn thông báo](https://yeachan-heo.github.io/oh-my-qoder-website/docs/#notifications)** - Thiết lập Discord, Telegram, Slack và webhook
- **[Quy trình khuyến nghị](https://yeachan-heo.github.io/oh-my-qoder-website/docs/#workflows)** - Chuỗi skill đã qua thực chiến cho các tác vụ phổ biến
- **[Ghi chú phát hành](https://yeachan-heo.github.io/oh-my-qoder-website/docs/#release-notes)** - Có gì mới trong mỗi phiên bản
- **[Website](https://yeachan-heo.github.io/oh-my-qoder-website)** - Hướng dẫn tương tác và ví dụ
...
- Gói thuê bao Qoder Max/Pro HOẶC Anthropic API key
...
**Chi phí:** 3 gói Pro (Qoder + Gemini + ChatGPT) bao phủ mọi thứ với khoảng $60/tháng.
...
Nếu Oh-My-Qoder giúp ích cho quy trình làm việc của bạn, hãy cân nhắc tài trợ:
