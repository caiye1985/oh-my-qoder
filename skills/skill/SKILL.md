...
2. Scan user skills at `${QODER_CONFIG_DIR:-~/.qoder}/skills/omc-learned/`
...
USER SKILLS (~/.qoder/skills/omc-learned/):
...
5. **Ask for scope:**
   - `user` → `${QODER_CONFIG_DIR:-~/.qoder}/skills/omc-learned/<name>/SKILL.md`
...
✓ Created skill at ~/.qoder/skills/omc-learned/custom-logger/SKILL.md
...
1. **Search for skill** in both scopes:
   - `${QODER_CONFIG_DIR:-~/.qoder}/skills/omc-learned/<name>/SKILL.md`
   - `.omc/skills/<name>/SKILL.md`
2. **If found:**
   - Display skill info (name, description, scope)
   - **Ask for confirmation:** "Delete '<name>' skill from <scope>? (yes/no)"
3. **If confirmed:**
   - Delete entire skill directory (e.g., `${QODER_CONFIG_DIR:-~/.qoder}/skills/omc-learned/<name>/`)
...
Assistant: Found skill 'old-logger' in user scope:
  ...
  Scope: user (~/.qoder/skills/omc-learned/)
...
```
Skill: custom-logger
Scope: user (~/.qoder/skills/omc-learned/custom-logger/)
Description: Enhanced logging with structured output
Triggers: log, logger, logging
Argument Hint: <level> [message]
Quality: 95% (if available)
Usage Count: 42 times (if available)
File Path: /home/user/.qoder/skills/omc-learned/custom-logger/SKILL.md
...
Description: Enhanced logging with structured output
Triggers: log, logger, logging
File: ~/.qoder/skills/omc-learned/custom-logger/SKILL.md
...
**Behavior:**
1. **Scan both scopes:**
   - User skills: `${QODER_CONFIG_DIR:-~/.qoder}/skills/omc-learned/`
   - Project skills: `.omc/skills/`
...
Then ask for scope:
- **User-level** (~/.qoder/skills/omc-learned/) - Available across all projects
...
✓ User skills directory exists: ~/.qoder/skills/omc-learned/
