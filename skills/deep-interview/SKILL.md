...
- Once ready, do **not** bridge into `omc-plan`, `autopilot`, `ralph`, `team`, or the hard-deprecated `omq autoresearch` CLI. Instead write the mission/evaluator setup artifacts and invoke:
