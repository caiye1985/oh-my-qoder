...
```
/oh-my-qoder:sciomc <goal>                    # Standard research with user checkpoints
/oh-my-qoder:sciomc AUTO: <goal>              # Fully autonomous until complete
/oh-my-qoder:sciomc status                    # Check current research session status
/oh-my-qoder:sciomc resume                    # Resume interrupted research session
/oh-my-qoder:sciomc list                      # List all research sessions
/oh-my-qoder:sciomc report <session-id>       # Generate report for session
```

### Quick Examples

```
/oh-my-qoder:sciomc What are the performance characteristics of different sorting algorithms?
/oh-my-qoder:sciomc AUTO: Analyze authentication patterns in this codebase
/oh-my-qoder:sciomc How does the error handling work across the API layer?
```
...
```
/oh-my-qoder:sciomc AUTO: Comprehensive security analysis of the authentication system
...
| Command | Action |
|---------|--------|
| `/oh-my-qoder:sciomc status` | Show current session progress |
| `/oh-my-qoder:sciomc resume` | Resume most recent interrupted session |
| `/oh-my-qoder:sciomc resume <session-id>` | Resume specific session |
| `/oh-my-qoder:sciomc list` | List all sessions with status |
| `/oh-my-qoder:sciomc report <session-id>` | Generate/regenerate report |
| `/oh-my-qoder:sciomc cancel` | Cancel current session (preserves state) |
