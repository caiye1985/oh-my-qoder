...
export interface StatuslineStdin {
  ...
  /** Model information from Qoder statusline stdin */
  model?: {
    id?: string;
    display_name?: string;
  };

  /** Context window metrics from Qoder statusline stdin */
  context_window?: {
  ...
  /** Rate limits from Qoder statusline stdin */
  rate_limits?: {
    five_hour?: {
      used_percentage?: number;
...
export interface HudRenderContext {
  ...
  /** Model display name from Qoder statusline stdin; null when unavailable */
  modelName: string | null;

  /** Raw model id from Qoder statusline stdin; used when full model format is requested */
  modelId?: string | null;
